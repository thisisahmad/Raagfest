        ...
        <section id="sponsors" className="py-24 bg-brand-black relative">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <span className="text-brand-blue text-sm font-bold uppercase tracking-widest mb-2 block">Partnership Opportunities</span>
                    <h2 className="text-4xl md:text-5xl font-display font-bold text-white uppercase">Become a <span className="text-brand-green">Sponsor</span></h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    ...
                    <motion.div
                        whileHover={{ y: -10 }}
                        className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-brand-green/30 transition-all group"
                    >
                        <div className="w-14 h-14 bg-brand-green/10 rounded-full flex items-center justify-center mb-6 group-hover:bg-brand-green group-hover:text-black transition-colors text-brand-green">
                            <Star size={24} />
                        </div>
                    ...
                    <motion.div
                        whileHover={{ y: -10 }}
                        className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-brand-blue/30 transition-all group"
                    >
                        <div className="w-14 h-14 bg-brand-blue/10 rounded-full flex items-center justify-center mb-6 group-hover:bg-brand-blue group-hover:text-white transition-colors text-brand-blue">
                            <Handshake size={24} />
                        </div>
                ...
                <div className="bg-gradient-to-r from-brand-blue/20 to-brand-green/20 border border-white/10 rounded-3xl p-12 text-center relative overflow-hidden">
