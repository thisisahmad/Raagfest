export default function SocialFeed() {
  return (
    <section id="social" className="relative py-14 md:py-20 overflow-hidden reveal-in" data-scroll-reveal>
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex justify-center reveal-in reveal-in-delay-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center min-h-[48px] gap-2 px-8 sm:px-10 py-3.5 sm:py-4 rounded-full glass-premium border border-white/20 hover:border-brand-orange/50 active:bg-white/5 text-white font-medium transition-all duration-300 card-lift touch-manipulation"
          >
